...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ...
        ('main', '0004_alter_homepage_content'),
    ]
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('page', modelcluster.fields.ParentalKey(on_delete=django.db.models.deletion.CASCADE, related_name='form_fields', to='main.contactpage')),
            ],
            options={
                'ordering': ['sort_order'],
                'abstract': False,
